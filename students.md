...
<div style="display: flex; align-items: flex-start; margin-bottom: 20px;">
  <div style="flex: 0 0 150px; padding-right: 20px;">
    <img src="/assets/img/Junseo.jpg" alt="New Student" style="width: 100%; height: auto;">
  </div>
  <div style="line-height: 1.5;">
    <h3 style="margin: 0;">Juneseo Kim (김준서)</h3>
    <p style="margin: 5px 0;">Undergraduate</p>
    <p style="margin: 5px 0;">Topic: Physics Simulation based on PIGNN</p>
...
<div style="display: flex; align-items: flex-start; margin-bottom: 20px;">
  <div style="flex: 0 0 150px; padding-right: 20px;">
    <img src="/assets/img/Daehun.jpg" alt="New Student" style="width: 100%; height: auto;">
  </div>  
  <div style="line-height: 1.5;">
    <h3 style="margin: 0;">Daehun Kim (김대훈)</h3>
    <p style="margin: 5px 0;">Undergraduate</p>
    <p style="margin: 5px 0;">Topic: Underwater Explosion Simulation</p>
